...
<div class="modal fade" id="reminder_modal_w" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog"> 
		<div class="modal-content shadow">
			<div class="modal-header">
				<div class="text-center">
					<h5 class="modal-title" id="exampleModalLabel"><i class="bi bi-clipboard-x"></i> Notice:</h5>	
				</div>	
			...
			<div class="modal-body p-5">
				...
				<div class="alert alert-success" role="alert">
					<ul>
						<li>Jquery:</li>
						<ul>
							<li> DataTables has been applied to the page</li>
						</ul>
					</ul>
				</div>
				<!-- TO DO and ERROR SECTION -->
				<div class="alert alert-warning" role="alert">
					<ul>
						<li>NEW MODULE:</li>
						<ul>
							<li>Author's Table</li>
						</ul>
						<li>ADD,EDIT,DELETE:</li>
						<ul>
							<li>Function needs auto-reload page(DataTables)</li>
							<li>reload() still not working</li>
						</ul>
					</ul>
				</div>	
				<!-- TO DO FOR WEBPAGE LAYOUT -->	
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-link" data-bs-dismiss="modal">Got, it</button>
			</div>
		</div>
	</div>
</div>
